            ...
            <div className="collapse navbar-collapse justify-content-end" id="navbarNavAltMarkup">
              <ul className="navbar-nav align-items-center">
                <li className="nav-item">
                  <a className="nav-link active" aria-current="page" href="/modul">Modul</a>
                </li>
                <li className="nav-item">
                ...
                <li className="nav-item">
                  <a className="nav-link" href="/home">Team</a>
                </li>
                <li className="nav-item">
                  <a className="nav-link" href="/memilihPraktikum">Materi</a>
                </li>
                ...
                <li className="nav-item dropdown">
                  ...
                  <ul className="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                    <li><a className="dropdown-item" href="/profile"><i className="bi bi-person"></i> Profile</a></li>
