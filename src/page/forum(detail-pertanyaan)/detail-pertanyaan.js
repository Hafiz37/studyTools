  ...
  return (
    <div>
      ...
      <section id="detailPertanyaan-head" class="container mt-5 p-3">
        ...
        <a href="/forum/DetailPertanyaan/Jawab"><button type="button" class="btn btn-primary fw-bold rounded-pill w-25 mt-3">Jawab</button></a>
      </section>
      ...
      <section id="detailPertanyaan-body" class="container mt-5 pb-5 d-flex flex-column align-items-center">
        ...
        <div class="perJawaban pb-3 mt-3">
          <div class="row deskripsi">
            <div class="col ms-2 mt-2 mb-3">
              <div class="row namaPenjawab fw-bold fs-3">Surya Saiful</div>
        ...
        <div class="perJawaban pb-3 mt-3">
          <div class="row deskripsi">
            <div class="col ms-2 mt-2 mb-3">
              <div class="row namaPenjawab fw-bold fs-3">Intan Dwi</div>
