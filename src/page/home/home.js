          ...
          <div class="row flex-lg-row align-items-center g-5 py-5">
            ...
            <div class="col-lg-6">
              ...
              <div class="mt-3 d-grid d-md-flex justify-content-md-start">
                <a href="/memilihPraktikum" class="btn btn-primary btn-lg rounded-pill shadow fw-bold fs-6 d-flex justify-content-center align-items-center">Mulai Belajar</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="forrum container col-xxl-8 px-4 py-3">
          <div class="row flex-lg-row-reverse align-items-center g-5 py-5">
            ...
            <div class="col-lg-6">
              ...
              <div class="mt-3 d-grid d-md-flex justify-content-md-start">
                <a href="/forum" class="btn btn-primary btn-lg rounded-pill shadow fw-bold fs-6 d-flex justify-content-center align-items-center">Forum</a>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class="card get-started p-md-5">
          <div class="row g-0">
            ...
            <div class="col-md-6 col-lg-4 d-flex flex-md-column align-items-center justify-content-center p-3">
              <a href="/memilihPraktikum" class="btn rounded-pill w-50 mb-md-4 mulai-belajar fw-bold">Mulai Belajar</a>
