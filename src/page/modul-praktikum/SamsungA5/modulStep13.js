                ...
                <div class="modul container-fluid d-flex flex-column align-items-center">
                  <div class="modul2 justify-content-start align-items-center gap-3">
                    ...
                    <i class="bi bi-caret-left fs-2"></i>
                            ...
                            <img src={komponen4} class="macamKomponen gambar drag-drop"/>
                            <img src={komponen5} class="macamKomponen gambar drag-drop"/>
                            <img src={komponen6} class="macamKomponen gambar drag-drop"/>
                  ...
                  <div class="komponen d-flex justify-content-between align-items-center">
                    ...
                    <div class="buttonModul d-flex justify-content-between align-items-center container">
                      ...
                      <button type="button" class="btnUlang btn rounded-pill fw-bold" onClick={balikGambar}>Balik</button>
