          ...
          <div class="row d-flex justify-content-center mt-3">
            <div class="col-lg-7">
              <div class="progress rounded-pill">
                <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="55.5" aria-valuemin="0" aria-valuemax="100" style={{ width: "55.5%" }}>55.5%</div>
              </div>
            </div>
          </div>
        </div>
