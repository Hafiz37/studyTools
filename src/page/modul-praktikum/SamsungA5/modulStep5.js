...
import hpbelumdirakit from '../../../../src/komponen/modul-3D/samsung-galaxy-A5-2017/langkah-langkah/langkah-8.png';
// --- hppasang hp yg sudah dirakit
import hpsudahdirakit from '../../../../src/komponen/modul-3D/samsung-galaxy-A5-2017/langkah-langkah/langkah-9.png';
          ...
          <div class="row d-flex justify-content-center mt-3">
            <div class="col-lg-7">
              <div class="progress rounded-pill">
                <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="18.5" aria-valuemin="0" aria-valuemax="100" style={{ width: "18.5%" }}>18.5%</div>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="border rounded-25 border-dark border-2 bg-light">
                <div className="dnd-items">
                  ...
                  <div className="my-2 border-top border-bottom border-dark border-2 p-2 text-center">
                    ...
                    <img src={komponen9} class="macamKomponen gambar drag-drop" data-bs-toggle="tooltip" data-bs-placement="top" title="front cam(kamera depan)" />
