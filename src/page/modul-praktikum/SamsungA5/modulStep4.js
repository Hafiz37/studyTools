...
import hpbelumdirakit from '../../../../src/komponen/modul-3D/samsung-galaxy-A5-2017/langkah-langkah/langkah-7a.png';
// --- hppasang hp yg sudah dirakit
import hpsudahdirakit from '../../../../src/komponen/modul-3D/samsung-galaxy-A5-2017/langkah-langkah/langkah-7.png';
...
function ModelStep4() {
  ...
  function selanjutnya(e) {
    e.preventDefault();
    if (pasang == 1) {
      window.location.replace("ModulA5step5");
    } else {
          ...
          <div class="row d-flex justify-content-center mt-3">
            <div class="col-lg-7">
              <div class="progress rounded-pill">
                <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="14.8" aria-valuemin="0" aria-valuemax="100" style={{ width: "14.8%" }}>14.8%</div>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="border rounded-25 border-dark border-2 bg-light">
                <div className="dnd-items">
                  ...
                  <div className="my-2 border-top border-bottom border-dark border-2 p-2 text-center">
                    ...
                    <img src={komponen5} class="macamKomponen gambar drag-drop" data-bs-placement="top" title="RCV(ear speaker)" /> 
                    <img src={komponena} class="macamKomponen gambar drag-drop" id="gambarterpilih" status="terpilih" data-bs-placement="top" title="main cam(kamera belakang)" />
                    <img src={komponen2} class="macamKomponen gambar drag-drop" data-bs-placement="top" title="proximity(sensor cahaya)" />
                  </div>
                </div>
