...
// --komponen Depan
import komponena from '../../../../src/komponen/modul-3D/samsung-galaxy-A5-2017/komponen/komponen-5-a.png';
// --komponen Belakang
import komponenb from '../../../../src/komponen/modul-3D/samsung-galaxy-A5-2017/komponen/komponen-5-b.png';
// --- hp adalah hp yg belum dirakit
import hpbelumdirakit from '../../../../src/komponen/modul-3D/samsung-galaxy-A5-2017/langkah-langkah/langkah-6.png';
// --- hppasang hp yg sudah dirakit
import hpsudahdirakit from '../../../../src/komponen/modul-3D/samsung-galaxy-A5-2017/langkah-langkah/langkah-13.png';
...
function ModelStep8() {
  ...
  function selanjutnya(e) {
    e.preventDefault();
    if (pasang == 1) {
      window.location.replace("ModulA5step9");
    } else {
          ...
          <div class="row d-flex justify-content-center mt-3">
            <div class="col-lg-7">
              <div class="progress rounded-pill">
                <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="29.6" aria-valuemin="0" aria-valuemax="100" style={{ width: "29.6%" }}>29.6%</div>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="border rounded-25 border-dark border-2 bg-light">
                <div className="dnd-items">
                  ...
                  <div className="my-2 border-top border-bottom border-dark border-2 p-2 text-center">
                    <img src={komponena} class="macamKomponen gambar drag-drop" id="gambarterpilih" status="terpilih" data-bs-toggle="tooltip" data-bs-placement="top" title="RCV(ear speaker)" />
