...
// --komponen Depan
import komponena from '../../../../src/komponen/modul-3D/samsung-galaxy-A5-2017/komponen/komponen-12-a.png';
// --komponen Belakang
import komponenb from '../../../../src/komponen/modul-3D/samsung-galaxy-A5-2017/komponen/komponen-12-b.png';
// --- hp adalah hp yg belum dirakit
import hpbelumdirakit from '../../../../src/komponen/modul-3D/samsung-galaxy-A5-2017/langkah-langkah/langkah-31.png';
// --- hppasang hp yg sudah dirakit
import hpsudahdirakit from '../../../../src/komponen/modul-3D/samsung-galaxy-A5-2017/langkah-langkah/langkah-32.png';
...
function ModelStep23() {
  ...
  function selanjutnya(e) {
    e.preventDefault();
    if (pasang == 1) {
      window.location.replace("ModulA5step24");
    } else {
          ...
          <div class="row d-flex justify-content-center mt-3">
            <div class="col-lg-7">
              <div class="progress rounded-pill">
                <div class="progress-bar progress-bar-striped progress-bar-animated" role="progressbar" aria-valuenow="85.1" aria-valuemin="0" aria-valuemax="100" style={{ width: "85.1%" }}>85.1%</div>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="border rounded-25 border-dark border-2 bg-light">
                <div className="dnd-items">
                  ...
                  <img src={komponen8} class="macamKomponen gambar drag-drop" data-bs-toggle="tooltip" data-bs-placement="top" title="sim card2 & sd card" />
                    <img src={komponena} class="macamKomponen gambar drag-drop" data-bs-toggle="tooltip" id="gambarterpilih" status="terpilih" data-bs-placement="top" title="nfc/mst ant" />
